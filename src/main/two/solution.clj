...
(defn solve-part-one
  ...
  (->>
   ...
   (map to-instruction)
   (reduce (fn [submarine instruction] (navigate submarine instruction)) (->Submarine 0 0))
   distance-from-start
   )
  )
